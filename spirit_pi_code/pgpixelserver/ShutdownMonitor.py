...
# Disable warnings if another script has changed the pin
GPIO.setwarnings(False)

# time int1 needs to be held low to initiate a power-down/halt of the Pi
INT1_POWERDOWN_TIMEOUT = 0.500
...
try:
    while 1:
        ...
        sleep(0.05)
        # Pin set as input, pull-up (PIC weak pullup also sets this high)
        GPIO.setup(int1Pin, GPIO.IN)
